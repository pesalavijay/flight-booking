...
from .serializers import BookingSerializer, PaymentSerializer, CreateBookingSerializer,RefundPreviewSearializer, CancellationSerializer
    ...
    def post(self, request):
        ...
        try:
            razorpay_order = razorpay_client.order.create(
                amount = int(seat.base_price*100),
                currency = 'INR',
                reciept = booking.pnr,
                payment_capture = 1
            )
            ...
            payment.delete()
            return Response(
                {'error':f'Failde to create payment order : {str(e)}'},
...
class VerifyPaymentView(APIView):
    ...
    def post(self, request):
        ...
        except razorpay.exceptions.SignatureVerificationError:
...
class RefundPreviewView(APIView):
    ...
    def get(self, request, booking_id):
        ...
        return Response({
            ...
            'message':           f'You will get ₹{refund_amount} back ({refund_percentage}% refund)'
        }, status=status.HTTP_200_OK)
...
class CancelBookingView(APIView):
    ...
    def post(self, request, booking_id):
        ...
        # TODO: Process refund via Razorpay in Celery task
