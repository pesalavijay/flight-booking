...
class Flight(models.Model):
    Airline_CHOICES = [('airIndia','AirIndia'),('vistara' , 'Vistara'),('indigo' , 'IndiGo'),('starair', 'StartAir'),('spicejet', 'SpiceJet'),]
...
class Seat(models.Model):
    CLASS_CHOICES = [('firstclass', 'First Class'),('business', 'Business'),('economy', 'Economy'),]
